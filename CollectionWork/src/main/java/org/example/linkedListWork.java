...
/**
 * The class in which the test results are calculated for LinkedList.
 */
public class linkedListWork {
    ...
    /**
     * Calculating "Get" method test results for a LinkedList class.
    ...
    /**
     * Calculating "Add" method test results for a LinkedList class.
     * @param N number of repetitions of the method.
     * @return Time for which the method will work N number of times.
     */
    ...
    /**
     * Calculating "Delete" method test results for a LinkedList class.
     * @param N number of repetitions of the method.
     * @return Time for which the method will work N number of times.
     */
    ...
    /**
     * Calculating "Size" method test results for a LinkedList class.
     * @param N number of repetitions of the method.
     * @return Time for which the method will work N number of times.
     */
    ...
    /**
     * Calculating "Set" method test results for a LinkedList class.
     * @param N number of repetitions of the method.
     * @return Time for which the method will work N number of times.
     */
